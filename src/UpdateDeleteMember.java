...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            if(checkid==0)
                JOptionPane.showMessageDialog(null, "Member Id Dose Not Exit");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String idcard=jTextField9.getText();
        String age=jTextField7.getText();
        String amout=jTextField8.getText();
        try
        {
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("UPDATE member SET name=?,tel=?,email=?,idcard = ?,age=?,amout=? where id=?");
            ps.setString(1,name);
            ps.setString(2, tel);   
            ps.setString(3,email);
            ps.setString(4, idcard);
            ps.setString(5,age);
            ps.setString(6,amout);
            ps.setString(7,id);
            ps.executeUpdate();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        int a=JOptionPane.showConfirmDialog(null, "Do u want to Delete","Select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            String id=jTextField1.getText();
            try
